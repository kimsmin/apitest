...
public class GetProperty_Internal {
	...
	public void run() throws URISyntaxException, IOException, RequestSigningException {
		...
		URI uri = URI.create("https://akab-wwstu3bvulrikd3z-bsithmyjodkqc2lv.luna.akamaiapis.net/papi/v1/properties/prp_242425?contractId=ctr_C-1BBSI2U&groupId=grp_61240");
	...
	public static void main(String[] args) throws URISyntaxException, IOException, RequestSigningException {
		GetProperty_Internal lp = new GetProperty_Internal();
		lp.run();
