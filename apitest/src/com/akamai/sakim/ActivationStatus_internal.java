...
public class ActivationStatus_internal {
	...
	public void run() throws URISyntaxException, IOException, RequestSigningException {
		...
		URI uri = URI.create("https://akab-wwstu3bvulrikd3z-bsithmyjodkqc2lv.luna.akamaiapis.net/papi/v0/properties/prp_242425/activations/atv_7070814?contractId=ctr_C-1BBSI2U&groupId=grp_61240");
	...
	public static void main(String[] args) throws URISyntaxException, IOException, RequestSigningException {
		ActivationStatus_internal lp = new ActivationStatus_internal();
		lp.run();
