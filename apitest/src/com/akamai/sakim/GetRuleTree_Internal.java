...
public class GetRuleTree_Internal {
	...
	public void run() throws URISyntaxException, IOException, RequestSigningException {
		...
		URI uri = URI.create("https://akab-wwstu3bvulrikd3z-bsithmyjodkqc2lv.luna.akamaiapis.net/papi/v1/properties/prp_242425/versions/44/rules?contractId=ctr_C-1BBSI2U&groupId=grp_61240&validateRules=true&validateMode=fast");
	...
	public static void main(String[] args) throws URISyntaxException, IOException, RequestSigningException {
		GetRuleTree_Internal lp = new GetRuleTree_Internal();
		lp.run();
