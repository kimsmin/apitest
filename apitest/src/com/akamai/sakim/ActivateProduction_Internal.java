...
public class ActivateProduction_Internal {
	...
	public void run() throws URISyntaxException, IOException, RequestSigningException {
		...
		String requestBody = "{\"propertyVersion\": 63,\"network\": \"PRODUCTION\",\"note\": \"Sample activation\",\"useFastFallback\": false,\"notifyEmails\": [\"sakim@akamai.com\"],\"acknowledgeWarnings\": [\"msg_7a2aa72bca3f894607c126436861cb73fb82d677\"]}";
		requestBody="{\"propertyVersion\": 63,\"network\": \"PRODUCTION\",\"note\": \"Sample activation\",\"useFastFallback\": false,\"notifyEmails\": [\"sakim@akamai.com\"],\"acknowledgeWarnings\": [\"msg_7a2aa72bca3f894607c126436861cb73fb82d677\"],"+ "\"complianceRecord\":{\"noncomplianceReason\":\"NO_PRODUCTION_TRAFFIC\", \"ticketId\":\"myticket001\"}}";
	...
	public static void main(String[] args) throws URISyntaxException, IOException, RequestSigningException {
		ActivateProduction_Internal lp = new ActivateProduction_Internal();
		lp.run();
